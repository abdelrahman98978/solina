...
const INITIAL_TEST_DRIVES: TestDriveLead[] = [
  {
    ...
    modelId: 'prado-2026',
    modelName: 'تويوتا لاند كروزر برادو 2026',
  ...
  },
  {
    ...
    modelId: 'camry-2026',
    modelName: 'تويوتا كامري 2026 هايبرد',
  ...
  },
  {
    ...
    modelId: 'lc300-2026',
    modelName: 'تويوتا لاند كروزر LC300 2026',
...
const INITIAL_SERVICES: ServiceAppointmentLead[] = [
  {
    ...
    vehicleModel: 'تويوتا راف فور 2024 هايبرد',
...
const INITIAL_QUOTATIONS: QuotationRecord[] = [
  {
    ...
    vehicleName: 'تويوتا لاند كروزر برادو 2026',
  ...
  },
  {
    ...
    vehicleName: 'تويوتا كامري 2026 هايبرد',
